...
public class OrderController {
    ...
    public OrderController(OrderService orderService,
                           ...
                           Order> orderDtoResponseMapper, UserService userService,
    ...
    public List<OrderResponseDto> getHistory(@RequestParam Long userId) {
        List<Order> order = orderService.getOrdersHistory(userService.get(userId));
        return order.stream().map(orderDtoResponseMapper::toDto)
