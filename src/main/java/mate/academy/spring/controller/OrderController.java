...
public class OrderController {
    ...
    public OrderResponseDto complete(@RequestParam String userId) {
        ShoppingCart shoppingCart = shoppingCartService.getByUser(userService.get(Long.parseLong(userId)));
