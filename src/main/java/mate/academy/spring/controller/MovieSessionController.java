...
public class MovieSessionController {
    ...
    public List<MovieSessionResponseDto> getAllAvailableSessionsForMovieByIdAndDate(
            @RequestParam Long id,
            @RequestParam
            @DateTimeFormat(pattern = "dd.MM.yyyy") LocalDate date) {
        return movieSessionService.findAvailableSessionsForMovieByIdAndDate(id, date).stream()
