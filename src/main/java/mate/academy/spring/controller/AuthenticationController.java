...
public class AuthenticationController {
    ...
    @PostMapping
    public UserResponseDto register(@RequestBody UserRequestDto dto) throws AuthenticationException {
        ...
        throw new AuthenticationException("User with email: " + dto.getEmail() + " already exists.");
    }
}
