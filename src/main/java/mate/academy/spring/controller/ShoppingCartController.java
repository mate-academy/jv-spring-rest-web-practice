...
public class ShoppingCartController {
    ...
    public ShoppingCartController(ShoppingCartService shoppingCartService,
        ...
        this.shoppCartDtoResponseMapper = shoppCartDtoResponseMapper;
    }
    ...
    public ShoppingCartResponseDto addToShoppingCart(@RequestParam Long userId,
        ...
        return shoppCartDtoResponseMapper.toDto(shoppingCartService.getByUser(user));
    }

    @GetMapping("/by_user")
    public ShoppingCartResponseDto getByUser(@RequestParam Long userId) {
        return shoppCartDtoResponseMapper
