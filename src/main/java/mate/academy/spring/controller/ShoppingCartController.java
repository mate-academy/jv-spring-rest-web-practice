...
public class ShoppingCartController {
    ...
    public ShoppingCartResponseDto getByUserId(@RequestParam Long userId) {
        ShoppingCart cartDtoByUserId = shoppingCartService.getByUser(userService.get(userId));
        return mapper.toDto(cartDtoByUserId);
    }

    @PutMapping("/movie-sessions")
    public void addMovieSessionByParams(@RequestParam Long userId,
