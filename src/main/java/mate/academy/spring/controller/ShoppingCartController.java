...
public class ShoppingCartController {
    ...
    @GetMapping("by-user")
    public ShoppingCartResponseDto getCartByUser(@RequestParam Long id) {
        return cartDtoResponseMapper.toDto(shoppingCartService.getByUser(userService.get(id)));
    }
    ...
    public ShoppingCartResponseDto update(@RequestParam Long userId,
        ...
        return cartDtoResponseMapper.toDto(shoppingCartService.getByUser(user));
    }
}
