...
public class ShoppingCartController {
    ...
    @GetMapping("/by-user")
    public ShoppingCartResponseDto getAllAvailableSessions(@RequestParam Long id) {
        return shoppingCartResponseMapper
                .toDto(shoppingCartService.getByUser(userService.getById(id)));
    }
    ...
    public void addMovieSession(@RequestParam Long userId,
        ...
        shoppingCartService
                .addSession(movieSessionService
