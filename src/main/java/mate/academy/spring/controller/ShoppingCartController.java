...
public class ShoppingCartController {
    ...
    private final DtoResponseMapper<ShoppingCartResponseDto, ShoppingCart> cartResponseMapper;
    ...
    public ShoppingCartResponseDto getShoppingCartByUserId(@RequestParam Long userId) {
        return cartResponseMapper.toDto(shoppingCartService.getByUser(userService.get(userId)));
    }
